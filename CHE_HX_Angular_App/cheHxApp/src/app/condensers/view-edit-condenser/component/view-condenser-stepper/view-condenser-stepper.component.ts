...
@Component({
  ...
  templateUrl: './view-condenser-stepper.component.html',
  styleUrls: ['./view-condenser-stepper.component.scss']
})
export class ViewCondenserStepperComponent implements OnInit {
  ...
  ngOnChanges(): void {
    this.value = this.initialValue;
    this.renderedValue = this.value;
    if(this.checked === true && this.renderedValue === 0){
      this.renderedValue = 1;
      this.value = 1;
      this.min = 1;
    } 
    else if(this.checked === true && this.renderedValue >= 1){
