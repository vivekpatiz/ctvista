package com.danaherdigital.che_hx.calcengine;
...
public class SimpleCorsFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
		...
		if (!Objects.isNull(request.getHeader(ApplicationConstants.ORIGING))) {
			ESAPI.httpUtilities().setHeader(response, "Access-Control-Allow-Origin",
					request.getHeader(ApplicationConstants.ORIGING));
		}
