...
public class CalculationConstants {
	...
	public static final String COGEN_STEAM_FLOW1 = "cogenSteamFlow1";
	...
	public static final String CONDENSER_BP ="condenserBP";
	public static final String CONDENSER_BACK_PRESSURE ="condenserBackPressure";
	public static final String LP_EXHAUST_STEAM_TEMP ="lpExhaustSteamTemp";
	public static final String HOT_WELL_TEMP ="hotwellTemp";
	public static final String HOT_WELL_TEMP1 ="hotwellTemp1";

	public static final String BOILER_STEAM_FLOW ="boilerSteamFlow";
	public static final String ATTEMPERATRION_STEAM_FLOW ="attemperationSteamFlow";
	public static final String CONDENSER_CW_IN_TEMPS ="condenserCwInTemps";
	public static final String CONDENSER_CW_OUT_TEMPS ="condenserCwOutTemps";
	public static final String CONDENSER_CW_INLET_PRESSURE ="condenserCwInletPressure";
	public static final String CONDENSER_CW_OUTLET_PRESSURE ="condenserCwOutletPressure";
	public static final String CONDENSER_CW_DELTA_PRESSURE ="condenserCwDeltaPressure";
	public static final String CW_DELTA_P1 ="cwDeltaP";

	public static final String AVG_CONDENSER_BP ="avgCondenserBP";
	public static final String AVG_TURBINE_EXHAUST_STEAM_TEMP ="avgTurbineExhaustSteamTemp";
	public static final String AVG_HOTWELL_TEMP ="avgHotwellTemp";
	public static final String SUM_TOTAL_BOILER_STEAM_FLOW ="sumTotalBoilerSteamFlow";
	public static final String SUM_TOTAL_ATTEMP_STEAM_FLOW ="sumTotalAttempSteamFlow";
	public static final String SUM_TOTAL_COGEN_STEAM_FLOW ="sumTotalCogenSteamFlow";
	public static final String AVG_CW_TEMP_IN ="avgcWTempIn";
	public static final String AVG_CW_TEMP_OUT ="avgcWTempOut";
	public static final String AVG_CW_INLET_PRESSURE ="avgcwInletPressure";
	public static final String AVG_CW_OUTLET_PRESSURE ="avgcwOutletPressure";
	public static final String AVG_CW_DELTA_P ="avgcwDeltaP";
	...
	public static final String TOTAL_ATTEMP_STEAM_FLOW = "attemperationSteamFlow1";
